...
ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:eternal_incense')
    ...
    .addAlt(RotatingTooltip([
        Text.translatable('tooltips.kubejs.eternal_incense.alt.2', ChampionHighFreqProtectionHover).gray(),
        Text.translatable('tooltips.kubejs.eternal_incense.alt.3', ChampionLowFreqProtectionHover).gray(),
    ], 1000))
)