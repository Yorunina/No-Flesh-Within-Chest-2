...
ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:blood_crystal')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.blood_crystal.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.blood_crystal.shift.1', Text.gold('2')))
)
...
ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:relics_scroll_1')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.relics_scroll_1.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.relics_scroll_1.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:relics_scroll_2')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.relics_scroll_2.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.relics_scroll_2.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_1')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_1.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_1.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_2')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_2.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_2.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_3')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_3.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_3.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_4')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_4.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_4.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_5')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_5.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_5.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_6')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_6.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_6.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_7')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_7.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_7.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_8')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_8.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_8.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_9')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_9.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_9.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_10')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_10.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_10.shift.1'))
)

ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:task_singularity_11')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.task_singularity_11.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.task_singularity_11.shift.1'))
)
