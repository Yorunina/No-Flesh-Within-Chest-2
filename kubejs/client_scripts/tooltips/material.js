...
ApplyMultiStateTooltip(new MultiStateTooltip('kubejs:relic_scroll')
    .setShiftDescription(Text.translatable('tooltips.kubejs.tool.shift.1'))
    .setShiftHoldingDescription(Text.translatable('tooltips.kubejs.tool.shift_holding.1'))
    .addDefault(Text.translatable('tooltips.kubejs.relic_scroll.default.1').gray())
    .addShift(Text.translatable('tooltips.kubejs.relic_scroll.shift.1'))
)