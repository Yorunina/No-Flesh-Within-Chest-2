...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:lava_life_cycle_system')
    ...
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.lava_life_cycle_system.ctrl.2'))
)
...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:pure_color_reaction')
    .addDefault(Text.translatable('tooltips.kubejs.pure_color_reaction.default.1').gray())
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.pure_color_reaction.ctrl.1'))
    .addCtrl(Text.translatable('tooltips.kubejs.pure_color_reaction.ctrl.2', DyeRGBConfigHover))
    .addCtrl(Text.translatable('tooltips.kubejs.pure_color_reaction.ctrl.3', DyeRGBConfigHover, Text.gold('0.01')))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:blood_crystal_factory')
    .addDefault(Text.translatable('tooltips.kubejs.blood_crystal_factory.default.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.blood_crystal_factory.alt.1', Text.gold('10%')))
    .addAlt(Text.translatable('tooltips.kubejs.blood_crystal_factory.alt.2', Text.gold('64')))
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.blood_crystal_factory.ctrl.1', Text.gold('10%')))
    .addCtrl(Text.translatable('tooltips.kubejs.blood_crystal_factory.ctrl.2', PheromoneConfigHover))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:machine_witch_fibroma')
    .addDefault(Text.translatable('tooltips.kubejs.machine_witch_fibroma.default.1').gray())
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.machine_witch_fibroma.ctrl.1'))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:pressurized_arm')
    .addDefault(Text.translatable('tooltips.kubejs.pressurized_arm.default.1').gray())
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.pressurized_arm.ctrl.1', KeyActiveHover, PressurizedArmFluidConfigHover))
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:ore_vein_generator')
    .addDefault(Text.translatable('tooltips.kubejs.ore_vein_generator.default.1').gray())
    .addCtrl(TransdimensionalMechanizedType)
    .addCtrl(Text.translatable('tooltips.kubejs.ore_vein_generator.ctrl.1', KeyActiveHover))
    .addCtrl(Text.translatable('tooltips.kubejs.ore_vein_generator.ctrl.2', VeinCoreOreHover))
)