...
ServerEvents.recipes(event => {
    ...
    event.recipes.create.filling(
        ...
        [Fluid.of('kubejs:molten_gold_fluid', 90)], 20 * 3)
    /** 铁 */
    event.recipes.create.mixing(
    ...
    event.recipes.create.filling(
        ...
        [Fluid.of('kubejs:molten_iron_fluid', 90)], 20 * 3)
    /** 铜 */
    event.recipes.create.mixing(
    ...
    event.recipes.create.filling(
        ...
        [Fluid.of('kubejs:molten_copper_fluid', 90)], 20 * 3)
    /** 钻石 */
    event.recipes.create.mixing(
    ...
    event.recipes.create.filling(
        ...
        [Fluid.of('kubejs:molten_diamond_fluid', 90)], 20 * 3)
    /** 绿宝石 */
    event.recipes.create.mixing(
    ...
    event.recipes.create.filling(
        ...
        [Fluid.of('kubejs:molten_emerald_fluid', 90)], 20 * 3)
})