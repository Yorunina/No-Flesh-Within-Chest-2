...
AStages.addRestrictionForRecipe('ancient_incense/ancient_incense_recipe', 'relics_knowledge_2', 'biomancy:bio_forging', ['kubejs:ancient_incense'])
...
ServerEvents.recipes(event => {
    ...
    event.recipes.biomancy.bio_forging([Item.of('biomancy:healing_additive', 1), Item.of('biomancy:living_flesh', 16), Item.of('chestcavity:chest_opener', 1), Item.of('minecraft:iron_ingot', 16)], Item.of('chestcavity:surgical_box', '{Inventory:[],InventoryType:"kubejs:player_17",Size:17}'), 'biomancy:organ', 10)
    ...
    event.recipes.biomancy.bio_forging([Item.of('biomancy:living_flesh'), Item.of('kubejs:swollen_stamen'), Item.of('minecraft:weeping_vines')], Item.of('kubejs:tentacles_harvester'), 'biomancy:organ', 30)
