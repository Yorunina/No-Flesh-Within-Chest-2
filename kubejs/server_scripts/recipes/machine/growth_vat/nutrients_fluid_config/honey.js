...
const HoneyOrganDataWeightModel = new WeightRandomModel()
    .addWeightRandom({ name: 'chestcavity:health', mean: 1.5, sigma: 0.8 }, 30)
    .addWeightRandom({ name: 'chestcavity:nutrition', mean: 1.5, sigma: 0.8 }, 15)
    .addWeightRandom({ name: 'chestcavity:digestion', mean: 1.5, sigma: 0.8 }, 15)
    .addWeightRandom({ name: 'chestcavity:metabolism', mean: 1.5, sigma: 0.8 }, 15)
