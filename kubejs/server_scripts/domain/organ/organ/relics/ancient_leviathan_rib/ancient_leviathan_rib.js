// priority: 500
RegistryOrgan('kubejs:ancient_leviathan_rib').setRank(4)
 ...
 */
function AncientLeviathanRibChestCavityUpdate(customData, event, organItem, organIndex, slotType) {
 ...
 * @param {string} slotType
 */
function AncientLeviathanRibOrganTakeOff(customData, event, organItem, organIndex, slotType) {
...
RegistryOrganStrategy(
    new OrganStrategyModel('kubejs:ancient_leviathan_rib')
