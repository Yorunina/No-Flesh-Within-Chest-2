// priority: 500
RegistryOrgan('kubejs:poison_sand_gland').setRank(3)
...
function PoisonSandGlandEntityKill(customData, event, organItem, organIndex, slotType) {
    ...
    SetChestCavityOrgan(customData, customData.killer.chestCavityInstance, Item.of('kubejs:ancient_poison_sand_gland'), organIndex, slotType, true)
}
