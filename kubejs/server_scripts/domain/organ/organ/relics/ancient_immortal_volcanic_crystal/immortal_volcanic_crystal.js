// priority: 500
RegistryOrgan('kubejs:immortal_volcanic_crystal').setRank(3)
...
function ImmortalVolcanicCrystalEntityKill(customData, event, organItem, organIndex, slotType) {
    ...
    SetChestCavityOrgan(customData, customData.killer.chestCavityInstance, Item.of('kubejs:ancient_immortal_volcanic_crystal'), organIndex, slotType, true)
}
