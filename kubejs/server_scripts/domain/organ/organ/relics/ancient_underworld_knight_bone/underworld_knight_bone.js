// priority: 500
RegistryOrgan('kubejs:underworld_knight_bone').setRank(3)
...
function UnderworldKnightBoneEntityKill(customData, event, organItem, organIndex, slotType) {
    ...
    SetChestCavityOrgan(customData, customData.killer.chestCavityInstance, Item.of('kubejs:ancient_underworld_knight_bone'), organIndex, slotType, true)
}
