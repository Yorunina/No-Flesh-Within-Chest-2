// priority: 500
RegistryOrgan('kubejs:ancient_harbinger_lung').setRank(3)
 ...
 */
function AncientHarbingerLungChestCavityUpdate(customData, event, organItem, organIndex, slotType) {
 ...
 * @param {string} slotType
 */
function AncientHarbingerLungTakeOff(customData, event, organItem, organIndex, slotType) {
...
RegistryOrganStrategy(
    new OrganStrategyModel('kubejs:ancient_harbinger_lung')
