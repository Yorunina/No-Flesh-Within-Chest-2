// priority: 500
RegistryOrgan('kubejs:cold_armor_plate').setRank(2)
...
function ColdArmorPlateEntityKill(customData, event, organItem, organIndex, slotType) {
    ...
    SetChestCavityOrgan(customData, customData.killer.chestCavityInstance, Item.of('kubejs:shining_cold_armor_plate'), organIndex, slotType, true)
}
