// priority: 500
RegistryOrgan('kubejs:wizened_toxic_gland')
...
*/
function WizenedToxicGlandKeyActive(customData, event, organItem, organIndex, slotType) {
...
RegistryOrganStrategy(
    new OrganStrategyModel('kubejs:wizened_toxic_gland')
        .addOnlyStrategy('key_active', WizenedToxicGlandKeyActive)
)