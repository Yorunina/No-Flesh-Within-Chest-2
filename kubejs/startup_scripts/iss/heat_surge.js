...
StartupEvents.registry('irons_spellbooks:spells', event => {
    event.create('heat_surge')
        ...
        .onCast(ctx => {
            ...
            const targets = GetLivingWithinRadiusVec3d(level, entity.position(), radius, (level, pEntity) => !ISSDamageSources.islyFireBetween(pEntity, entity) && ISSUtils["hasLineOfSight(net.minecraft.world.level.Level,net.minecraft.world.entity.Entity,net.minecraft.world.entity.Entity,boolean)"](level, entity, pEntity, true))
